...
void MyGLWidget::updateAll() { update(); }

void MyGLWidget::getQuaternions(const float a, const float b, const float c,
                                const float d) {
  q0 = a;
  q1 = b;
  q2 = c;
 ...
 * widget has been resized (and also when it is shown for the first time because
...
void MyGLWidget::resizeGL(int width, int height) {
  ...
  glLoadIdentity();
  // Here we use a simple frustum projection
